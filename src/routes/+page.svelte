...
<div class="header">
	...
	/>
	<p style="margin: 0.03rem 0;margin-bottom: -5em; text-align: center;">
		Quick historical context for anthropology.
	</p>
	<a href="/settings">
		<button style="scale: 0.3; transform: translate(500%, -110%); margin: 0;" class="btn">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				x="0px"
				y="0px"
